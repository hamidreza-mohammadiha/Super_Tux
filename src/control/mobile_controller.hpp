...
private:
  ...
  /** Button touch area on the screen */
  Rectf m_rect_directions, m_rect_jump, m_rect_action, m_rect_escape;
  /** Button image rectangle, which is smaller than the touch area */
  Rectf m_draw_directions, m_draw_jump, m_draw_action, m_draw_escape;
